...
export function createEndpointHandlers(paykit: PayKit<any>): {
  ...
  return {
    ...
    '/customer/update': (id, params) =>
      paykit.customers.update(id, params),
    ...
    '/checkout/update': (id, params) =>
      paykit.checkouts.update(id, params),
    '/checkout/delete': id => paykit.checkouts.delete(id),

    '/subscription/create': params =>
      paykit.subscriptions.create(params),
    ...
    '/payment/update': (id, params) =>
      paykit.payments.update(id, params),
    '/payment/capture': (id, params) =>
      paykit.payments.capture(id, params),
